...
using codestellar.bolierplate.Web.Controllers.Results;
using codestellar.bolierplate.Web.Models.Account;
...
{
    public class AccountController : bolierplateControllerBase
    {
